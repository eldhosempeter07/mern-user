import {ADD_USER, ADD_USER_BEGIN, ADD_USER_FAIL, ADD_USER_SUCCESS, DELETE_USER_BY_ID, DELETE_USER_BY_ID_BEGIN, DELETE_USER_BY_ID_FAIL, DELETE_USER_BY_ID_SUCCESS, EDIT_USER_BY_ID, EDIT_USER_BY_ID_BEGIN, EDIT_USER_BY_ID_FAIL, EDIT_USER_BY_ID_SUCCESS, GET_USERS, GET_USERS_BEGIN, GET_USERS_FAIL,GET_USERS_SUCCESS, GET_USER_BY_ID, GET_USER_BY_ID_BEGIN, GET_USER_BY_ID_FAIL, GET_USER_BY_ID_SUCCESS} from './actionTypes'
...
export const editUserByID = ({id,data,callback,image}) => ({
