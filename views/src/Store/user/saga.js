...
import { addUserBegin, addUserFail, addUserSuccess, deleteUserByIDBegin, deleteUserByIDFail, deleteUserByIDSuccess, editUserByIDBegin, editUserByIDFail, editUserByIDSuccess, getUserByIDBegin, getUserByIDFail, getUserByIDSuccess, getUsersBegin, getUsersFail, getUsersSuccess } from './actions'
import { ADD_USER, DELETE_USER_BY_ID, EDIT_USER_BY_ID, GET_USERS, GET_USER_BY_ID } from './actionTypes'
...
function* addUser({data,callback}) {
    ...
    try {
        ...
        const response = yield call(add,"/user",data)
        console.log(response);
        if(response){
            console.log(response);
...
function* editUserByID({id,data,callback,image}) {
    try {
